...
\hypersetup{
  ...
  pdfkeywords={Rust, GCC, Polonius, borrow checker, static
analysis, compiler},
  hidelinks,
...
\begin{figure}
\centering
\includesvg[width=0.8\textwidth,height=\textheight]{polonius.svg}
...
\begin{figure}
\centering
\includesvg[width=0.8\textwidth,height=\textheight]{./pipeline.svg}
